...
const HERO_TITLE = 'Powering Journeys with Trusted Battery Performance';
const HERO_SUBCOPY =
  'Find dependable batteries for automotive, marine, and commercial needs, backed by a nationwide dealer network and expert local support.';
            ...
            <div className="max-w-182">
              <div className={clsx({ shim: screenLayer })}>
                ...
                <div className="mt-7 text-xl md:text-2xl">
                  <p className="text-center lg:text-left">{HERO_SUBCOPY}</p>
                </div>
        ...
        <div className="container mx-auto flex min-h-238 justify-center px-4">
          ...
          >
            <div className={clsx({ shim: screenLayer })}>
              ...
              {/* Description */}
              <div className="mt-7 text-xl md:text-2xl">
                <p className="text-center">{HERO_SUBCOPY}</p>
              </div>
