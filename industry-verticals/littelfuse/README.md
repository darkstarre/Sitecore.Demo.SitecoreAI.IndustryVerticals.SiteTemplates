...
Littelfuse is an industrial technology demo site template based on the Energy vertical.
...
2. Starting from the root of the repository navigate to site app folder
   `cd industry-verticals/littelfuse`
...
6. Install dependencies:
   from `industry-verticals/littelfuse` run `npm install`
...
6. Provide Editing host name `littelfuse` as per xmcloud.build.json
