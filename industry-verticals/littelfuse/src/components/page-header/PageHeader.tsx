...
type PageHeaderProps = ComponentProps & {
  fields: Fields;
};

export const Default = ({ params, fields, rendering }: PageHeaderProps): JSX.Element => {
      ...
      <div className="container">
        <div className="grid gap-8 lg:grid-cols-4">
          <div className="space-y-8 lg:col-span-3">
            <h2>{title ? <Text field={title} /> : null}</h2>
            <div className="text-lg">{content ? <RichText field={content} /> : null}</div>
          </div>
