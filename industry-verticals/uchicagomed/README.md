...
UChicagoMed is a clean scaffold of the Nova Medical healthcare demo with a dedicated site key and rendering host (`uchicagomed`).
...
2. Starting from the root of the repository navigate to site app folder
   `cd industry-verticals\\uchicagomed`
...
6. Install dependencies:
   from `industry-verticals\\uchicagomed` run `npm install`
...
6. Provide Editing host name `uchicagomed` as per xmcloud.build.json
