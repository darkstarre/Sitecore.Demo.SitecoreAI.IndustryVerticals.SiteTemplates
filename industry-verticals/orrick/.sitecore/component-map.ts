...
import * as PortalDashboard from 'src/components/portal-dashboard/PortalDashboard';
...
import * as AttorneysListing from 'src/components/attorneys-listing/AttorneysListing';
import * as AttorneyDetails from 'src/components/attorney-details/AttorneyDetails';
...
export const componentMap = new Map<string, NextjsContentSdkComponent>([
  ...
  ['AttorneysListing', { ...AttorneysListing }],
