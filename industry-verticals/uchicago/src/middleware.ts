...
export const config = {
   ...
   */
  // Exclude root-level static assets (/public); multisite middleware can otherwise intercept them (broken logos, etc.).
  matcher: [
    '/',
    '/((?!api/|_next/|healthz|sitecore/api/|-/|favicon.ico|sc_logo.svg|[^/]+\\.(?:ico|png|jpg|jpeg|gif|svg|webp|woff2?|txt)$).*)',
  ],
};
