...
UChicago is a demo website designed to represent a modern, patient-focused digital experience.The site demonstrates how healthcare providers can create a trustworthy and user-friendly platform that supports
...
2. Starting from the root of the repository navigate to site app folder
   `cd industry-verticals\uchicago`
...
6. Install dependencies:
   from `industry-verticals\uchicago` run `npm install`
...
6. Provide Editing host name `uchicago` as per xmcloud.build.json
